...
class _FiveTabState extends State<FiveTab> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: new AppBar(
        title: new Text("Stadium", style: TextStyle(fontWeight: FontWeight.w400),),
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Flexible(child: Text(article.title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 21.0),), flex: 3,),
                          Flexible(
                            flex: 1,
                            child: Container(
                                height: 80.0,
