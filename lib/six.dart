  ...
  Widget build(BuildContext context)
  {
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text('Market', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
                    ...
                    child: Padding
                      ...
                      child: Row
                        ...
                        [
                          ...
                          Text('Add Item to Sales', style: TextStyle(color: Colors.white))
                        ],
                      ),
                    ),
                  ),
